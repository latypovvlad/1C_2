...
1)В разделе «Покупки», вы сможете вводить информацию ваших расходников. 
При нажатии на кнопку «создать» можно ввести название вашего продукта, его цену и количество. 
Сумму же автоматически посчитает приложение. 
Дата ставится автоматически, но если захотите, то можете её запросто поменять. 
Это всё сохранится в разделе "покупки" в виде таблицы. Там будут указаны все нужные параметры. Добавил три примера, для показа функционала.
